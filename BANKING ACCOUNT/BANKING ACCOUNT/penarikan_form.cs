...
{
    public partial class penarikan_form : Form
    {
        public penarikan_form()
        {
            InitializeComponent();
        }
        ...
        private void btn_simpan_Click(object sender, EventArgs e)
        {
            #region validasi
            int m_nominal = 0;
            if(!int .TryParse (txt_setoran .Text .Trim (),out m_nominal )){
                MessageBox.Show("Inputan Harus Berupa Angka");
                txt_setoran.ResetText();
                txt_setoran.Focus();
                return;
            }
            ...
            myaccount.Balance = myaccount.withdraw(m_nominal );
